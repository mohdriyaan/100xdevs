...
/* Reference elements are stored in heap. Elements are also stored using pointers but have the same address. So when we make change to arr1 then the changes also applied to arr1    */
